        ...
        <Template {...{ kcContext, i18n, doUseDefaultCss, classes }} active="password">
            ...
            <form action={url.passwordUrl} className="form-horizontal" method="post">
                ...
                {password.passwordSet && (
                    <div className="form-group">
                        ...
                        <div className="col-sm-10 col-md-10">
                            <Input.Password type="password" id="password" name="password" autoFocus autoComplete="current-password" />
                        </div>
                    </div>
                )}
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-10 col-md-10">
                        <Input.Password type="password" id="password-new" name="password-new" autoComplete="new-password" />
                    </div>
                </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-10 col-md-10">
                        <Input.Password type="password" id="password-confirm" name="password-confirm" autoComplete="new-password" />
                    </div>
                </div>
                ...
                <div className="form-group">
                    <div id="kc-form-buttons" className="col-md-offset-2 col-md-10 submit">
                        <div>
                            <Button type="primary" htmlType="submit" value="Save" name="submitAction">
                                {msg("doSave")}
                            </Button>
                        </div>
                    </div>
